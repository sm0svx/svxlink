...
bool UsrpLogic::initialize(void)
{
...
#if (INTERNAL_SAMPLE_RATE == 16000)
  AudioFilter *local_splatter_filter = new AudioFilter("LpCh9/-0.05/5000");
#else
  AudioFilter *local_splatter_filter = new AudioFilter("LpCh9/-0.05/3500");
#endif
  ...
  prev_src = netclipper;
    ...
    // Remove high frequencies generated by the previous clipping
#if (INTERNAL_SAMPLE_RATE == 16000)
  AudioFilter *net_splatter_filter = new AudioFilter("LpCh9/-0.05/5000");
#else
  AudioFilter *net_splatter_filter = new AudioFilter("LpCh9/-0.05/3500");
#endif
