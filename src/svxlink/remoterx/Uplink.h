/**
@file	 Uplink.h
@brief   Contains the base class for implementing a remote receiver uplink
...
This is the base class for implementing a remote receiver uplink. That is,
the link to the SvxLink core.
*/
class Uplink : public SigC::Object
{
  public:
    static Uplink *create(Async::Config &cfg, const std::string &name, Rx *rx);
