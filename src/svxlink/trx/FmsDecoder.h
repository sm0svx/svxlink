...
#ifndef FMS_DECODER_INCLUDED
#define FMS_DECODER_INCLUDED
...
/**
 * @brief   This is the base class for implementing a Fms decoder
 * @author  Tobias Blomberg, SM0SVX & Adi Bier / DL1HRC
 * @date    2012-07-10
 */
class FmsDecoder : public sigc::trackable, public Async::AudioSink
{
  public:
    /**
     * @brief 	Create a new Fms decoder object
     * @param 	cfg A previously initialised configuration object
     * @param 	name The name of the receiver configuration section
     * @returns Returns a new Fms object or 0 on failure
     *
     * Use this function to create new Fms decoder objects. What Fms
     ...
     * contain a configuration variable Fms_DEC_TYPE that points out the
     * decoder type to use. Valid values are: INTERNAL (only one at the moment)
     */
    static FmsDecoder *create(Async::Config &cfg, const std::string& name);

    /**
     * @brief 	Destructor
     */
    virtual ~FmsDecoder(void) {}
    ...
    */
    ...
    /**
     * @brief 	Tell the Fms decoder to flush the previously written samples
     *
    ...
    */
    sigc::signal<void, std::string> fmsDetected;

    sigc::signal<void, bool> fms_mute;
  ...
  protected:
     ...
     * @param 	name The name of the receiver configuration section
     *
     * FmsDecoder objects are created by calling FmsDecoder::create.
     */
    FmsDecoder(Async::Config &cfg, const std::string &name)
