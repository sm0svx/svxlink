...
/**
@brief  A squelch detector that read squelch state from a GPIO port using
        GPIOD v2 c++ api
@author Rui Barreiros / CR7BPM
@date   2025-09-02

This squelch detector reads the squelch indicator signal from a GPIO input pin
using the gpiod v2 c++ api.
*/
