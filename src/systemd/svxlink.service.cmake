...
ExecStart=/bin/sh -c '@CMAKE_INSTALL_PREFIX@/bin/svxlink /usr/bin/svxlink --logfile=/var/log/svxlink --config=$CFGFILE --pidfile=/run/svxlink.pid --runasuser=$RUNASUSER'
