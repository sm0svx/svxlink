...
This class implements an audio decoder that use the AMBE audio codec.
*/
class AudioDecoderAmbe : public AudioDecoder
{
  ...
  private:
    ...
    AudioDecoderAmbe(const AudioDecoderAmbe&);
    AudioDecoderAmbe& operator=(const AudioDecoderAmbe&);
